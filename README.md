...
## Environments
- Preview: https://main--new-capstone--AnuragKumarGupta.hlx.page/
- Live: https://main--new-capstone--AnuragKumarGupta.hlx.live/
...
1. Open the `new-capstone` directory in your favorite IDE and start coding :)
